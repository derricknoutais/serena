            ...
            <div class="flex flex-col space-y-6">
                ...
                >
                    ...
                    <div v-if="mustVerifyEmail && !user.email_verified_at">
                        <p class="-mt-4 text-sm text-serena-text-muted">
                            Votre adresse e-mail n'est pas vérifiée.
                            <Link
                                :href="send()"
                                as="button"
                                class="text-serena-primary underline decoration-serena-border underline-offset-4 transition-colors duration-300 ease-out hover:decoration-current"
                            >
                        ...
                        <div
                            ...
                            class="mt-2 text-sm font-medium text-serena-accent"
                        >
